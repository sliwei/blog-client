    ...
    <transition name="bounce">
      <div class="cont-con" v-show="sta">
        <div class="cont">
          <div
            :class="`cont-cen ${
              contMax && isDetailRoute ? 'cont-cen-max' : ''
            }`"
          >
            <div class="content">
              <nuxt />
          ...
          <div class="cont-left">
            ...
            <div
              :class="`${
                !(contMax && isDetailRoute) && 'right-content'
              } content`"
            >
              <transition name="bounce">
                <awei-search
                  v-if="(sta && searchSta) || (contMax && isDetailRoute)"
                ></awei-search>
              </transition>
              <transition name="bounce">
                <awei-recent
                  v-show="sta || (contMax && isDetailRoute)"
                ></awei-recent>
              </transition>
              <!--              <transition name="bounce">-->
              ...
              <transition name="bounce">
                <awei-nav
                  v-if="
                    (sta && navSta && menu.tocHtml) ||
                    (contMax && isDetailRoute && menu.tocHtml)
                  "
                ></awei-nav>
              </transition>
            </div>
          ...
          <div
            :class="`cont-right ${
              contMax && isDetailRoute ? 'cont-right-min' : ''
            }`"
          >
            <div class="content">
              <transition name="bounce">
...
.to-top {
  ...
  transition: 0.4s ease width, 0.4s ease transform, 0.4s ease border-radius;
}
...
.slideInDown-enter-active {
  animation: slideInDown-in 0.5s;
  transform-origin: center top;
}

.slideInDown-leave-active {
  animation: slideInDown-in 0.5s reverse;
  transform-origin: center top;
}
...
.slideInUp-enter-active {
  animation: slideInUp-in 0.5s;
  transform-origin: center top;
}

.slideInUp-leave-active {
  animation: slideInUp-in 0.5s reverse;
  transform-origin: center top;
}

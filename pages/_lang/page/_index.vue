              ...
              <div>
                <div class="img">
                  <nuxt-link :to="$i18n.path(`/article/${item.code}`)">
                    <img
                      :src="
                        item.img || 'https://source.unsplash.com/random/442x294'
                      "
                      alt=""
                    />
                  </nuxt-link>
                ...
                <div class="txt">
                  <div class="info">
                    ...
                    <span
                      >{{ $t('pages.page.unknown') }} {{ item.user_name }}</span
                    >
                  </div>
                  <div class="title">
                    <nuxt-link :to="$i18n.path(`/article/${item.code}`)">{{
...
export default {
  ...
  async asyncData({ app, route }) {
    const { data } = await app.$axios.get(
      `/blog/client/blog/list?pageIndex=${route.params.index || 1}&pageSize=8`
    )
